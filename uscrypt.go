...
//
// where LogN, R, P are scrypt cost parameters encoded as decimal numbers;
// SALT is a random salt, PWDHASH is the output of scrypt, both encoded in
// Base64 using custom alphabet.
//
package uscrypt
